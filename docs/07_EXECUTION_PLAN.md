...
> **Статус (2026-04-23):** план этой серии фактически исполнен в итерациях 3
> и 4 (см. `06_FIX_PROGRESS.md`). Документ оставлен как исторический
> артефакт — он описывает state-of-planning на момент 2026-04-22 и может
> ссылаться на файлы, которые уже были удалены / смержены при
> последующем warm-редизайне (например,
> `lib/screens/message_details/widget/message_details_widget.dart`
> сейчас не существует — его логика переехала в
> `screens/message_details/screen/message_details_screen.dart`).
